...
#     icon: coursera
#     summary: |
#       I studied the foundational concept of neural networks and deep learning. By the end, I was familiar with the significant technological trends driving the rise of deep learning; train, and apply fully connected deep neural networks; implement efficient (vectorized) neural networks; identify key parameters in a neural network’s architecture; apply deep learning to your own applications.
...
I am a Young Scientist at Shanghai AI Laboratory. Currently, I fortunately collaborate with [Prof. Yu Cheng](https://ych133.github.io/), work on Efficient AI for LLMs/VLMs, including algorithm & system co-design on Efficient Architectures, e.g., Linear Attention and Mixture-of-Experts, and Large-Scale Distributed Training.

See our research projects: [Linear-MoE](https://github.com/OpenSparseLLMs/Linear-MoE), [LASP-2](https://github.com/OpenSparseLLMs/Linear-MoE), [Linearization (Liger)](https://github.com/OpenSparseLLMs/Linearization), [MoM](https://github.com/OpenSparseLLMs/MoM), [NHA](https://github.com/JusenD/NHA) and [Comba](https://github.com/AwesomeSeq/Comba-triton) for technical details. My previous work [Lightning Attention](https://arxiv.org/abs/2405.17381) and [LASP](https://arxiv.org/abs/2404.02882) series are the key techniques in [MiniMax-01](https://arxiv.org/abs/2501.08313) 456B LLM and VLM.
